...
<Link href="/walmart-vriddhi-msme-summit-2024" >
          <Image src="/images/photo1.jpeg" className="w-100 d-sm-none d-lg-block d-xs-none d-none" />
          <Image src="/images/photo4.jpeg" className="w-100 d-lg-none"/>
        </Link>
      ) : (
          <>
      <Image src="/images/photo2.jpeg" className="w-100 d-sm-none d-lg-block d-xs-none d-none" />
      <Image src="/images/photo3.jpeg" className="w-100 d-lg-none"/>
          </>
              )}
