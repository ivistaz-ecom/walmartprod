  ...
  return (
    <>
      ...
      <Container className='wbg-blue-m p-4 rounded-5 text-center'>
        ...
        <Image src="/images/line_2.svg" width={100} height={20} alt="What’s in it for the MSMEs?" className="my-1" />
      ...
      <Container className='mt-5 w-70 py-5 text-center'>
      ...
      <Container fluid className='wbg_grey p-4'>
        <p className='fs-6 mb-0'><b className='bogle-medium'>Disclaimer:</b> Completion of these modules does not assure onboarding to Walmart.com. Walmart Marketplace team will reach out to you if your products align with market demand, providing onboarding and incubation support to assist potential sellers.</p>
      </Container>
      <FloatingMenu />
      <MarketFooter />
